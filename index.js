...
ircCtrl = function($scope, $http, $element){
  import$($scope, {
    week: {
      ...
      hover: {
        ...
        set: function(it){
          ...
          import$(this.cur, it);
          this.cur.event = $scope.week.event[this.cur.d] || "　";
    ...
    hover: function(e, n){
      ...
      import$($scope.hoverItem, n);
      return ref$ = $scope.hoverItem, ref$.tx = tx, ref$.ty = ty, ref$.lx = lx, ref$.ly = ly, ref$;
    }
  });
  return $http.get('g0v-count.json').success(function(data){
    var len, weekday, offset, dmonth, v, ref$, min, max;
    $scope.nick = $scope.aux.bubble.nodes({
    ...
    return $scope.talkSum = $scope.nick.reduce(function(){
